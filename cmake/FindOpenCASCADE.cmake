...
SET( 
  OpenCASCADE_LINK_DIRECTORY "${OpenCASCADE_LIBRARY_DIR}" 
  CACHE 
  STRING "OCC link directory" 
  FORCE
)
SET( 
  OpenCASCADE_INCLUDE_DIR "${OpenCASCADE_INCLUDE_DIR}" 
  CACHE 
  STRING "OCC include directory" 
  FORCE
)
# reset variable
...
MESSAGE( 
 ...
 "| OpenCASCADE_CONFIG_FILE=${OpenCASCADE_CONFIG_FILE}\n"
